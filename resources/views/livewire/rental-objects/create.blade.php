<div class="max-w-2xl">
    <flux:heading size="xl" class="mb-6">{{ __('Add Property') }}</flux:heading>

    <flux:card>
        <form wire:submit="save" class="space-y-6">
            <flux:field>
                <flux:label>{{ __('Object Number') }}</flux:label>
                <flux:input wire:model="object_number" placeholder="z.B. FRE-001" required />
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <flux:field>
                    ...
                    <flux:input wire:model="year_built" type="number" min="1800" :max="date('Y')" placeholder="z.B. 1954" />
