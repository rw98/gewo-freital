<div class="space-y-4 pt-4 border-t border-zinc-200 dark:border-zinc-700">
    <flux:heading size="sm">{{ __('forms.builder.text_options') }}</flux:heading>

    <flux:input
        type="number"
        wire:model.live.debounce.500ms="editingField.config.min_length"
        :label="__('forms.builder.min_length')"
        min="0"
    />
