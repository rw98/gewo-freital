...
class AppointmentReminderNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('listing_requests.notification_appointment_reminder'))
            ->greeting(__('Hallo :name!', ['name' => $listingRequest->first_name]))
            ->line(__('Dies ist eine Erinnerung an Ihren Besichtigungstermin morgen.'))
            ->line(__('Wohnung: :title', ['title' => $listing->title]))
            ->line(__('Datum: :date', [
            ...
            ->line(__('Sollten Sie den Termin nicht wahrnehmen können, bitten wir Sie, diesen rechtzeitig abzusagen.'))
